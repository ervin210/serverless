...
Entities or individuals involved in hacking, unauthorized modifications, or financial gain from this software will face legal consequences.
                If you claim it its yours can show recipe for the product was used to run this  code on the datacenters and you are welcome change the licence again when you show the proff with payment for the services was used on datacenter  for this code to run.
3. Payment Terms
